...
def api_get_sell_fee(sell_token, buy_token, sell_amount, network="mainnet"):
    ...
    get_params = {"sellToken": sell_token.address, "buyToken": buy_token.address, "sellAmountBeforeFee": sell_amount}
...
def api_get_quote(
    sell_token, buy_token, sell_amount, valid_to, from_account, partiallyFillable=False, network="mainnet"
):
